...
(function (factory) {
    ...
    tTagBef1 = tTagBef + '><input type="hidden" id="file_id" value=""/><div class="kv-file-content">\n';//添加隐藏区域<input>
    ...
    $.fn.fileinput.defaults = {
        ...
        allowedFileTypes: null,//接收的文件后缀，如['jpg', 'gif', 'png'],不填将不限制上传文件后缀类型
        ...
        minFileSize: 0,//单位为kb，如果为0表示不限制文件大小
        ...
        dropZoneTitleClass: 'file-drop-zone-title',//拖拽区域类属性设置
