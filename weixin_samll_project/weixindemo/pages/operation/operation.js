...
Page({
  ...
  data: {
    ...
    areaName:'',
    priority:'',
    addUrl:'http://127.0.0.1:8082/cwm/addArea',
    modifyUrl:'http://127.0.0.1:8082/cwm/updateArea'
  },
  ...
  onLoad: function (options) {
    ...
    if(options.areaId==undefined)return;
    wx.request({
      url: 'http://127.0.0.1:8082/cwm/areaById',
      method:'GET',
