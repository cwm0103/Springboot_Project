...
TblHouse.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            ...
            {title: '房主名称', field: 'hourUser', visible: true, align: 'center', valign: 'middle'},
            {title: '房屋地址', field: 'hourAddress', visible: true, align: 'center', valign: 'middle'},
            {title: '房屋交付时间', field: 'hourData', visible: true, align: 'center', valign: 'middle'},
            {title: '房屋描述', field: 'hourDesc', visible: true, align: 'center', valign: 'middle'}
    ];
};
