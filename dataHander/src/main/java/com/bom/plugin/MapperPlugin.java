...
/**
 * Created by jindb on 2017/7/27.
 *
 * @author: jindb
 * @date: 2017/7/27 14:54
 * @description:
 */
public class MapperPlugin extends PluginAdapter {
    private static final String DEFAULT_DAO_SUPER_CLASS = "com.bom.domain.Mapper";
    private static final String DEFAULT_EXPAND_DAO_SUPER_CLASS = "";
    private static final String DEFAULT_DOMAIN = "com.bom.domain";
